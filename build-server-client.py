...
utils.callThrowIfError(f"dotnet publish {sourceDirNameServer} -r {platform} -o \"{serverOutputDir}\"")
...
utils.callThrowIfError(f"dotnet publish {sourceDirNameClient} -r {platform} -o \"{clientOutputDir}\"")
