...
utils.callThrowIfError(f"dotnet publish {sourceDirNameServer} -c release -r {platform} --self-contained -o \"{serverOutputDir}\"")
...
utils.callThrowIfError(f"dotnet publish {sourceDirNameClient} -c release -r {platform} --self-contained -o \"{clientOutputDir}\"")
