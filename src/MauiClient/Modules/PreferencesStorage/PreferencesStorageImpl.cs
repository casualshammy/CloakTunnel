...
namespace CloakTunnel.MauiClient.Modules.PreferencesStorage;
...
internal class PreferencesStorageImpl : IPreferencesStorage, IAppModule<IPreferencesStorage>
{
  ...
  {
    return _ctx.CreateInstance((ILog _logger, ITunnelsConfCtrl _tunnelsConfCtrl) => new PreferencesStorageImpl(_logger, _tunnelsConfCtrl));
  }
